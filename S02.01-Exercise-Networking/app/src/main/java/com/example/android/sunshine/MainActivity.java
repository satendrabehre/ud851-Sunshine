...
public class MainActivity extends AppCompatActivity {
    ...
    private class FetchWeatherTaks extends AsyncTask<URL , Void , String>{
        ...
        protected void onPostExecute(String result) {
            ...
            if(result!=null || !result.equals("")){
                ...
                mWeatherTextView.setText("Error in loading data");
            }
    ...
    public void loadWeatherData(){
        double[] location = SunshinePreferences.getLocationCoordinates(MainActivity.this);
        URL url = NetworkUtils.buildUrl(null, location);
        new FetchWeatherTaks().execute(url);
    }
